...
def enter():
    global create, map, ui, player, ga1, ga2, EnemyOne_L, EnemyTwo_L, EnemyThree_L, EnemyFour_L, E_Missile_L, MD_Missile_L, B_Missile_L, MiddleBoss_L, Boss_L, missile1, missile2, missile3, Missile1_L, Missile2_L, Missile3_L, Blast1_L, Blast2_L
...
# 플레이어 생명 UI 적용, 사운드 X , 플레이어 죽었을시 X
