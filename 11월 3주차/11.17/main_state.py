    ...
    def CMiddleBoss(self):
        if self.createmiddle >= 40:
            ...
            if self.middlel ==True:
                ...
                map.bosssound.set_volume(40)
                map.bosssound.repeat_play()
            if self.middlel == False:
                map.bosssound.pause()
                map.Bgm.resume()
    ...
    def CBoss(self):
        if (self.createboss >= 80 and self.bossl == False):
            ...
            if self.bossl == True:
                map.Bgm.pause()
                map.bosssound = load_music('object/Sound/bosssound.mp3')
                map.bosssound.set_volume(10)
                map.bosssound.repeat_play()
            if self.bossl == False:
                map.bosssound.resume()
                map.Bgm.resume()
...
class Ui:
    def __init__(self):
        self.font = load_font('object/Font/ENCR10B.TTF', 30)
        self.score = 0

    def draw(self):
        self.font.draw(50, 700, 'HEART: %d' % (player.gage))
        self.font.draw(20, 40, 'GrandAttack: %d' % (ga1.countga1))
        self.font.draw(550, 700, 'Score: %d' % (self.score))
        if (player.HEART == 0):
            self.font = load_font('object/Font/ENCR10B.TTF', 40)
            self.font.draw(70, 400, 'ReStart : [1] / EXIT : [ESC]', (255,255,255))
...
class Missile3:
    ...
    def __init__(self, x, y):
        ...
        self.y = y
        self.yy = 1
        if Missile3.missilesound == None:
            Missile3.missilesound = load_wav('object/Sound/Missilesound.wav')
            Missile3.missilesound.set_volume(20)
...
def enter():
    global create, map, ui, player, ga1, ga2, EnemyOne_L, EnemyTwo_L, EnemyThree_L, EnemyFour_L, E_Missile_L, MD_Missile_L, B_Missile_L, MiddleBoss_L, Boss_L, missile1, missile2, missile3, Missile1_L, Missile2_L, Missile3_L, Blast1_L, Blast2_L, Blast3_L
...
# 충돌체크(플레이어미사일, 중간보스,최종보스) #
    ...
    for missile3 in Missile3_L:
        for middleboss in MiddleBoss_L:
            if collide(missile3, middleboss):
                middleboss.life(1)
                middleboss_blast1 = Blast1(missile3.x, middleboss.y)
                Blast1_L.append(middleboss_blast1)
                ui.sp(10)
                if (middleboss.HEART == False):
                    MiddleBoss_L.remove(middleboss)
    ...
    for missile3 in Missile3_L:
        for boss in Boss_L:
            if collide(missile3, boss):
                boss.life(1)
                boss_blast1 = Blast1(missile3.x, boss.y)
                Blast1_L.append(boss_blast1)
                ui.sp(20)
                if (boss.HEART == False):
                    Missile3_L.remove(missile3)
    ...
    for missile3 in Missile3_L:
        for enemyone in EnemyOne_L:
            if collide(missile3, enemyone):
                enemyone.life(1)
                enemyone_blast3 = Blast3(missile3.x, enemyone.y)
                Blast3_L.append(enemyone_blast3)
                ui.sp(7)
                if (enemyone.HEART == False):
                    EnemyOne_L.remove(enemyone)
    ...
    for missile3 in Missile3_L:
        for enemytwo in EnemyTwo_L:
            if collide(missile3, enemytwo):
                enemytwo.life(1)
                enemytwo_blast3 = Blast3(missile3.x, enemytwo.y)
                Blast3_L.append(enemytwo_blast3)
                ui.sp(3)
                if (enemytwo.HEART == False):
                    EnemyTwo_L.remove(enemytwo)
    ...
    for missile3 in Missile3_L:
        for enemythree in EnemyThree_L:
            if collide(missile3, enemythree):
                enemythree.life(1)
                enemythree_blast3 = Blast3(missile3.x, enemythree.y)
                Blast3_L.append(enemythree_blast3)
                ui.sp(5)
                if (enemythree.HEART == False):
                    EnemyThree_L.remove(enemythree)
    ...
    for missile3 in Missile3_L:
        for enemyfour in EnemyFour_L:
            if collide(missile3, enemyfour):
                enemyfour.life(1)
                enemyfour_blast3 = Blast3(missile3.x, enemyfour.y)
                Blast3_L.append(enemyfour_blast3)
                ui.sp(3)
                if (enemyfour.HEART == False):
                    EnemyFour_L.remove(enemyfour)
...
# 충독체크(플레이어 필살기, 중간보스, 최종보스, 적1,2,3,4, 미사일) #
    ...
    for middleboss in MiddleBoss_L:
        if collide(middleboss, ga1):
            middleboss.life(1)
            middleboss_blast1 = Blast1(middleboss.x, middleboss.y)
            Blast1_L.append(middleboss_blast1)
            if ga1.y > 800:
                ga1.y = -200
                ga1.yy = 0
    ...
    for boss in Boss_L:
        if collide(boss, ga1):
            boss.life(1)
            boss_blast1 = Blast1(boss.x, boss.y)
            Blast1_L.append(boss_blast1)
            if ga1.y > 800:
                ga1.y = -200
                ga1.yy = 0
