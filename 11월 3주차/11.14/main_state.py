...
class Create:
    ...
    def CBoss(self):
        if (self.createboss >= 5 and self.bossl == False):
            self.bossl = True
            nBoss = Boss()
            Boss_L.append(nBoss)
            self.createboss = 0.0
...
class MD_Missile:
    ...
    def __init__(self, x, y):
        ...
        if MD_Missile.image == None:
            MD_Missile.image = load_image('object/Missile/boss11.png')
...
class MD_RMissile:
    ...
    def __init__(self, x, y):
        ...
        if MD_RMissile.image == None:
            MD_RMissile.image = load_image('object/Missile/boss11.png')
...
class MD_RRMissile:
    ...
    def __init__(self, x, y):
        ...
        if MD_RRMissile.image == None:
            MD_RRMissile.image = load_image('object/Missile/boss11.png')
...
class MD_LMissile:
    ...
    def __init__(self, x, y):
        ...
        if MD_LMissile.image == None:
            MD_LMissile.image = load_image('object/Missile/boss11.png')
...
class MD_LLMissile:
    ...
    def __init__(self, x, y):
        ...
        if MD_LLMissile.image == None:
            MD_LLMissile.image = load_image('object/Missile/boss11.png')
...
class B_Missile:
    ...
    def __init__(self, x, y):
        ...
        if B_Missile.image == None:
            B_Missile.image = load_image('object/Missile/boss111.png')
...
class B_DMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_DMissile.image == None:
            B_DMissile.image = load_image('object/Missile/boss111.png')
...
class B_DOMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_DOMissile.image == None:
            B_DOMissile.image = load_image('object/Missile/boss111.png')
...
class B_DOWMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_DOWMissile.image == None:
            B_DOWMissile.image = load_image('object/Missile/boss111.png')
...
class B_DOWNMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_DOWNMissile.image == None:
            B_DOWNMissile.image = load_image('object/Missile/boss111.png')
...
class B_CMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_CMissile.image == None:
            B_CMissile.image = load_image('object/Missile/boss111.png')
...
class B_RMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_RMissile.image == None:
            B_RMissile.image = load_image('object/Missile/boss111.png')
...
class B_RRMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_RRMissile.image == None:
            B_RRMissile.image = load_image('object/Missile/boss111.png')
...
class B_LMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_LMissile.image == None:
            B_LMissile.image = load_image('object/Missile/boss111.png')
...
class B_LLMissile:
    ...
    def __init__(self, x, y):
        ...
        if B_LLMissile.image == None:
            B_LLMissile.image = load_image('object/Missile/boss111.png')
